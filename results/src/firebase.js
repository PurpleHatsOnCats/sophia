...
import { getDatabase, ref, get, push, onValue } from "https://www.gstatic.com/firebasejs/12.7.0/firebase-database.js";
...
const answersLoc = ref(db, "answers");


async function loadResults() {
    return (await get(answersLoc)).val();
}
